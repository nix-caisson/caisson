...
#
# The root declaration of caisson itself: the mkLib call with every
...
caisson-core.mkLib {
  ...
  # The platforms this tree builds on; the core flake-parts module
  # defaults flake-parts' `systems` from it.
